...
import { ScrollView, Text, Pressable, StyleSheet, View, ImageBackground } from 'react-native'
...
const PreferencesScreen = () => {
  ...
  const handlePreferences = async () => {
    ...
    if (currentUser) {
      ...
      try {
        const selectedPreferences = preferences.filter(pref => pref.value === true).map(pref => pref.name);
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.row}>
          <Pressable style={styles.planButton}
            onPress={() => eventoDepor ? setEventoDepor(false) : setEventoDepor(true)}>
            <ImageBackground
              source={require('../assets/preferences/evento_deportivo.jpg')}
              style={styles.backgroundImage} />
            <Text style={styles.textButton}>Evento deportivo</Text>
            <Octicons name={eventoDepor ? 'check' : 'plus'} size={24} color="black" style={styles.icon} />
          </Pressable>
          <Pressable style={styles.planButton}
            ...
            <Octicons name={copas ? 'check' : 'plus'} size={24} color="black" style={styles.icon} />
          </Pressable>
        </View>
        <View style={styles.row}>
          <Pressable style={styles.planButton}
            onPress={() => fotografia ? setFotografia(false) : setFotografia(true)}>
            <ImageBackground
              source={require('../assets/preferences/fotografia.jpg')}
              style={styles.backgroundImage} />
            <Text style={styles.textButton}>Fotografía</Text>
            <Octicons name={fotografia ? 'check' : 'plus'} size={24} color="black" style={styles.icon} />
          </Pressable>
          <Pressable style={styles.planButton}
            ...
            <Octicons name={moda ? 'check' : 'plus'} size={24} color="black" style={styles.icon} />
          </Pressable>
        </View>
        <View style={styles.row}>
          <Pressable style={styles.planButton}
            ...
            <Octicons name={baile ? 'check' : 'plus'} size={24} color="black" style={styles.icon} />
          </Pressable>
          <Pressable style={styles.planButton}
            ...
            <Octicons name={relax ? 'check' : 'plus'} size={24} color="black" style={styles.icon} />
          </Pressable>
        </View>
        <View style={styles.row}>
          <Pressable style={styles.planButton}
            ...
            <Octicons name={cervezas ? 'check' : 'plus'} size={24} color="black" style={styles.icon} />
          </Pressable>
          <Pressable style={styles.planButton}
            ...
            <Octicons name={viajes ? 'check' : 'plus'} size={24} color="black" style={styles.icon} />
          </Pressable>
        </View>
        <View style={styles.row}>
          <Pressable style={styles.planButton}
            ...
            <Octicons name={juegos ? 'check' : 'plus'} size={24} color="black" style={styles.icon} />
          </Pressable>
          <Pressable style={styles.planButton}
            ...
            <Octicons name={cafe ? 'check' : 'plus'} size={24} color="black" style={styles.icon} />
          </Pressable>
        </View>
      </ScrollView>
